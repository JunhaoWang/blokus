...
static const Shape crossstrange{Coordinate(0, 0),Coordinate(1, 1),Coordinate(-1, 1),Coordinate(-1, 2),Coordinate(0, 1)};
...
static const Shape squaredot{Coordinate(0, 0),Coordinate(0, 1),Coordinate(1, 0),Coordinate(1, 1),Coordinate(2, 0)};
...
static const Shape boomerangsmallkill{Coordinate(0, 0),Coordinate(1, 0),Coordinate(1, 1),Coordinate(2, 1)};
static const Shape boomeranghalf{Coordinate(0, 0),Coordinate(1, 0),Coordinate(1, 1),Coordinate(2, 1),Coordinate(3, 1)};
...
int main(int argc, const char * argv[]) {
	...
	for (int i = 0; i < 1000000; ++i){
		grid.putShape(lshapebigmiddle, 1, 1, Orientation::LeftNeg, Cell::Red);
	}
	grid.print();
    return 0;
}
